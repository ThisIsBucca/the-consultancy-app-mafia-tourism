      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Ready to plan your Mafia Island adventure? Get in touch with our
            team and we'll help you create the perfect itinerary.
          </p>
        </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="mt-8 p-4 bg-primary/10 rounded-lg">
                ...
                <p className="text-primary text-sm">
                  ...
                  business hours. For urgent bookings, please call us directly.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                The best time for whale shark encounters is October to March.
                For diving and general activities, May to October offers the
              ...
              <p className="text-gray-600 mb-4">
                Not for all activities! We offer snorkeling tours for
                non-divers, and we can arrange diving courses for beginners who
                want to explore deeper waters.
              </p>
              ...
              <p className="text-gray-600">
                You can fly from Dar es Salaam (45 minutes) or take a ferry. We
                can help arrange transportation and provide detailed travel
                instructions.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Sunscreen, hat, swimwear, and a camera! We provide all
                snorkeling and diving equipment. We'll send you a detailed
                packing list after booking.
              </p>
              ...
              <p className="text-gray-600 mb-4">
                Yes! Many of our tours are family-friendly. We recommend a
                minimum age of 8 for snorkeling activities and 12 for diving.
              </p>
              ...
              <p className="text-gray-600">
                We offer flexible cancellation up to 48 hours before your tour.
                Weather-related cancellations are fully refundable or can be
                rescheduled.
              </p>
            </div>
          </div>
